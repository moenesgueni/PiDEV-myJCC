...
import GUI.ReservationHotel.AjouterReservationHotelController;
...
public class AjouterLocationController implements Initializable {
  ...
  /*---------------------ajout dans le serveur----------------*/
        ...
        String emplacement = "C:/Users/youssef/Desktop/temps.png" ;
        try {
            FileUpload.uploadFile(emplacement, "QRimages\\Vehicule\\" + newName);
        } catch (Exception ex) {
            Logger.getLogger(AjouterReservationHotelController.class.getName()).log(Level.SEVERE, null, ex);
        }
...
/*------------------------Envoyer QR code dans un email--------------------*/
    EmailAPI e = new EmailAPI();
      e.sendMail("youssefkchaou4@gmail.com",emplacement,"LocationVehicule"); 
