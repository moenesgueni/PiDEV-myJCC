...
public class UserSession {
    ...
    private UserSession(String Nom,String Prenom,String Genre,String Email,String MotDePasse,Type Role,String PhotoBD64,int NumTel) {
    this.Nom=Nom;
    this.Prenom=Prenom;
    this.Genre =Genre;
    this.Email=Email;
    ...
    public static synchronized UserSession getInstance(String Nom,String Prenom,String Genre,String Email,String MotDePasse,Type Role,String PhotoBD64,int NumTel) {
        if (instance == null) {
            instance = new UserSession(Nom,Prenom,Genre,Email,MotDePasse,Role,PhotoBD64,NumTel);
        }
        return instance;
    }
